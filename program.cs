        ...
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                do
                {
                    ...
                    Console.Write("inserire una coordinata: ");
                    x = Convert.ToInt32(Console.ReadLine());
                    Console.Write("inserire una seconda coordinata: ");
            ...
            Console.Title = "Vittoria";
            Console.WriteLine("per finire la partita hai utilizzato " + k + " mosse");
            Console.ReadKey();
        }
    }
}